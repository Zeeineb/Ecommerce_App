import { ArrowForward, Translate } from "@mui/icons-material";
import { Box, Container, Stack, Link, Typography, Button, useTheme } from "@mui/material";
        ...
        <Container  >
             ...
             return (
                            ...
                            sx={{ 
                             ...
                             >
                                ...
                                <Button sx={{ px: 5, py:1, mt:2, backgroundColor: "#222", boxShadow: " 0px 4px 16px rgba(43 , 52, 69, 0.1) ", color: "#fff", borderRadius: "1px", "&:hover": { bgcolor: "#151515", boxShadow: " 0px 4px 16px rgba(43 , 52, 69, 0.1) "},}} variant="contained">
                                    SHOP NOW
                                </Button>
            ...
            <Box sx={{ display: { xs: "none", md: "block", minWidth:"26.7%" } }}>
                <Box sx={{ position: "relative" }}>
                    <img width={"100%"} src="src\images\banner-17.jpg" alt=""></img>
